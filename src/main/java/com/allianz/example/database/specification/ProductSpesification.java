...
public class ProductSpesification extends BaseSpecification<ProductEntity> {
        ...
        for (SearchCriteria criteria : criteriaList) {
            ...
            if (criteria.getOperation().equalsIgnoreCase(">")) {
                ...
                if (criteria.getKey().equals("category")) {
                    ...
                    predicate = criteriaBuilder.equal(joinCategory.<String>get("name"), criteria.getValue());
                } else {
