...
public class CategoryController extends BaseController<CategoryEntity, CategoryDTO, CategoryRequestDTO, CategoryEntityRepository, CategoryMapper, CategoryService> {
